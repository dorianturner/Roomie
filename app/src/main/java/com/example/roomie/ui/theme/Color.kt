...
// Light theme — tuned olive / green identity
val LightPrimary = Color(0xFF7A8C37)      // tuned olive
val LightOnPrimary = Color(0xFFFFFFFF)
val LightSecondary = Color(0xFF6E7A3A)    // muted khaki/olive
val LightTertiary = Color(0xFF3C8A7F)     // subtle teal
...
val DarkSecondary = Color(0xFFA4B57A)
val DarkTertiary = Color(0xFF7AC8BB)
